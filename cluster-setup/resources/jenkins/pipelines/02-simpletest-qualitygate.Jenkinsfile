...
node {
    properties([
        parameters([
         ...
         string(defaultValue: 'http://simplenode.yourdomain.nip.io', description: 'URI of the application you want to run a test against', name: 'DeploymentURI', trim: false),
    ...
    stage('Initialize Keptn') {
        // TODO FIX REPO 
        keptn.downloadFile("https://raw.githubusercontent.com/keptn-sandbox/keptn-in-a-box/release-0.9.2/resources/jenkins/pipelines/keptn/shipyard-performance.yaml", 'keptn/shipyard.yaml')
