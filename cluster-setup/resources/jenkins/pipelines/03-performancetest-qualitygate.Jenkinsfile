...
node {
    ...
    stage('Initialize Keptn') {
        ...
        keptn.downloadFile('https://raw.githubusercontent.com/keptn-sandbox/keptn-in-a-box/release-0.9.2/resources/jenkins/pipelines/keptn/jmeter/load.jmx', 'keptn/jmeter/load.jmx')
        keptn.downloadFile('https://raw.githubusercontent.com/keptn-sandbox/keptn-in-a-box/release-0.9.2/resources/jenkins/pipelines/keptn/jmeter/jmeter.conf.yaml', 'keptn/jmeter/jmeter.conf.yaml')
